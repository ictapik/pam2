            ...
            <div class="row">
                ...
                <div class="col-sm">
                    ...
                    <form method="POST" class="form-scan">
                        ...
                        <input type="text" name="tnkb" value="<?= $_GET['tnkb']; ?>" class="form-control" readonly>
                        <input type="text" name="m_inout_id" value="<?= $_GET['m_inout_id']; ?>" class="form-control" readonly>
                        <!-- </div> -->
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" name="m_productasset_id" id="m_productasset_id" class="form-control" readonly>
                                <input type="text" name="m_product_id" id="m_product_id" class="form-control" readonly>
                            </div>
                        </div>
                    </form>
                    <!-- <p class="text-center">
