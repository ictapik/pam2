        ...
        <div class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="fas fa-dolly-flatbed"></i> Assets
            </a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <!-- <a class="dropdown-item" href="index.php?page=all_assets2&status=all&packingid=3M0A01B&productid=1046217&prefix=3M0A01B&suffix=4">Packing all type</a> -->
              <a class="dropdown-item" href="index.php?page=all_assets2&status=all&packingid=all&productid=all&prefix=all&suffix=all">Packing all type</a>
              <a class="dropdown-item" href="index.php?page=assets">Packing by type</a>
              <a class="dropdown-item" href="index.php?page=preferance">Preferance</a>
            </div>
          </li>
        </div>
