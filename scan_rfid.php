 ...
 * 1. Mencari data di tabel RFID_INVENTORY, apakah ada data atau tidak
...
$stid = oci_parse(
    $conn,
    "SELECT a.SERNO, a.DEVICENAME FROM RFID_INVENTORY a
    ...
    while ($row = oci_fetch_assoc($stid2)) {
        ...
        $stid3 = oci_parse(
            ...
            "INSERT INTO M_PRODUCTASSET_LOAD
                ...
                '$m_product_id', '$serno', sysdate, 100,'C-', (SELECT MOVEMENTDATE FROM M_INOUT WHERE M_INOUT_ID = '$m_inout_id'), '$tnkb', '$devicename')"
        );
