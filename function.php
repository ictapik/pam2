...
function dashboard_cal($start, $end, $packing_type = null)
{
    // START
    ...
    $dateStart = date("Y-m-d", strtotime("-30 day")); //$start;
    //echo "dateStart : " . strtoupper(date("d-M-y", strtotime($dateStart))) . "<br>";
    $dateEnd = date("Y-m-d"); //$end;
    //$dateEnd = date("Y-m-d", strtotime("+5 day")); //Test end date ;
    //$dateStart = date("Y-m-d", strtotime("-30 day", strtotime($dateEnd))); //Test start date x day before;
    //echo "dateEnd : " . date("Y-m-d", strtotime($dateEnd)) . "<br>";
...
?>
    ...
    <table id="" class="display table table-bordered" style="width:100%">
        ...
        //echo "Moday : " . date("N", strtotime("+0 day", strtotime($currentDate))) . "<br>";
        $thisMonth = 0;
        $totalRow = 1 + (intval(date("W", strtotime($dateEnd))) - intval(date("W", strtotime($dateStart))));
        if (date("n", strtotime($dateStart)) != date("n", strtotime($dateEnd)))
            $totalRow++;


        //START EDIT Oleh Wahyu untuk menangani error tampilan data kalender.
        //Setelah expired harus HAPUS.
        //Tgl: 05-JAN-2021
        //$totalRow = 6;
        //Expired: Akhir Februari (28-FEB-2021).
        //END EDIT.
                    ...
                    if ($j == 0) {
                        if ($thisMonth != $currentMonth) {
                            ...
                            if (date("n", strtotime($dateStart)) == date("n", strtotime($dateEnd))) {
                                ...
                                //echo "thisMonthStart : " . $thisMonthStart . "<br>";
                                //echo "thisMonthEnd : " . $thisMonthEnd . "<br>";
                                //echo "weekRow 2 : " . $weekRow . "<br>";
    ...
    // echo "total : " . $total_inout;
    // echo "<br>";
    // echo "percent in : " . $percent_in;
    // echo "<br>";
    // echo "percent out : " . $percent_out;
    // echo "<br>";
    // echo "percent out : " . $percent_total;
